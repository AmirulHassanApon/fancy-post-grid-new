...
function fpg_public_scripts(){
    ...
    wp_enqueue_script( 'fpg-isotope', plugins_url('/assets/js/isotope.pkgd.min.js', __FILE__) , array('jquery','imagesloaded'), $fpg_version, true );
    wp_enqueue_script( 'fpg-owl-carousel', plugins_url('/assets/js/owl.carousel.min.js', __FILE__) , array('jquery'), $fpg_version, true );
    wp_enqueue_script( 'fpg-jquery-flexslider', plugins_url('/assets/js/jquery.flexslider-min.js', __FILE__) , array('jquery'), $fpg_version, true );
    wp_enqueue_script( 'jquery-min', plugins_url('/assets/js/jquery.min.js', __FILE__) , array('jquery'), $fpg_version, true );
    wp_enqueue_script('swiper-bundle', plugins_url('/assets/js/swiper-bundle.min.js', __FILE__), array(), $fpg_version, true);
    wp_enqueue_script('fpg-main-js', plugins_url('/assets/js/main.js', __FILE__), array('swiper-bundle'), $fpg_version, true);
