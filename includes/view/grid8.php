        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="<?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?>">
                    <div class="rs-blog-layout-15-item <?php echo esc_attr($hover_class); ?>">
                        <div class="rs-content">
                            <div class="rs-meta">
                                <div class="meta-date">
                                    <span style="color: <?php echo esc_attr($fpg_meta_color); ?>; font-size: <?php echo esc_attr($fpg_meta_size); ?>px;">
                                        <?php echo get_the_date('M j, Y'); ?>
                                        
                                    </span>
                                </div>
                                <div class="meta-author">
                                    <a style="color: <?php echo esc_attr($fpg_meta_color); ?>; font-size: <?php echo esc_attr($fpg_meta_size); ?>px;"
